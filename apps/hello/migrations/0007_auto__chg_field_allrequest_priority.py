...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AllRequest.priority'
        db.alter_column(u'hello_allrequest', 'priority', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'AllRequest.priority'
        db.alter_column(u'hello_allrequest', 'priority', self.gf('django.db.models.fields.IntegerField')(max_length=1))
